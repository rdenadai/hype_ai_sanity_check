...
const twitterUrl = computed(() => {
  ...
  return `https://twitter.com/intent/tweet?url=aihypesanitycheck.tech/${profile?.value?.id}/${score.value}&text=${text} ${domain.value}${profileImgUrl.value}&hashtags=ai,hype,fallacy,anthropomorphism`
});
